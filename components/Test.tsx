...
const Test = () => {
  ...
  return (
    <main className="flex flex-1 flex-col">
      <article className="wrapper my-12 flex gap-12 ">
        ...
        <section className="bg-sky-200/15 border w-[40%] flex flex-col gap-3 border-gray-900/40 px-12 py-8 rounded-xl shadow-md">
